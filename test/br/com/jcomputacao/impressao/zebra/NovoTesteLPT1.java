...
//            saida.println(comandoImpressora);
            ...
            saida.println("D10");
            saida.println("ZT");
            saida.println("LO80,5,485,0");
            saida.println("GG80,10, \"LOGORT1\"");
            saida.println("I8,3,351");
            saida.println("A10,10,0,1,1,1,N,\"Cooperativa   Mista   de   Trabalho  dos\"");
            saida.println("A10,23,0,1,1,1,N,\"Motoristas  Autonomos  de  Taxi Especial\"");
            saida.println("A10,36,0,1,1,1,N,\"de Sao Paulo - Radio-Taxi\"");
            saida.println("A10,49,0,1,1,1,N,\"CNPJ:46.553.947/0001-20  CCM:8.179.517-3\"");
            saida.println("A10,70,0,2,1,1,N,\"          VIA CONTABILIDADE        .\"");
            saida.println("LO5,95,575,0");
            saida.println("A10,110,0,2,1,2,N,\"4378315\"");
            saida.println("B115,110,0,2,2,6,70,B,\"4378315\"");

            saida.println("A80,225,0,1,1,1,N,\"Recepcionista\"");
            saida.println("A220,225,0,1,1,1,N,\"Ponto de partida\"");
            saida.println("LO80,240,130,0");
            saida.println("LO220,240,160,0");
            saida.println("A80,250,0,1,1,1,N,\"TATI\"");
            saida.println("A220,250,0,1,1,1,N,\"Aeroporto de Congonhas\"");

            saida.println("A80,295,0,1,1,1,N,\"Destino\"");
            saida.println("LO80,310,80,0");
            saida.println("A80,320,0,3,1,1,N,\"AV. JUSCELINO KUBTSCHEK\"");

            saida.println("A80,365,0,1,1,1,N,\"Complemento\"");
            saida.println("LO80,380,80,0");
            saida.println("A80,390,0,3,1,1,N,\"ATE 951 LADO IMPAR\"");

            saida.println("A360,365,0,1,1,1,N,\"Cep\"");
            saida.println("LO360,380,80,0");
            saida.println("A360,390,0,3,1,1,N,\"04543-000\"");
